...
v1=$(curl -sSL "https://raw.githubusercontent.com/NearVPS/VPS-MX_Oficial/master/SCRIPT-v8.4g%20Oficial/Version")
...
clear && clear
msg -bar2
echo -e " \e[5m\033[1;100m   =====>> ►► 🐲 MULTIX - SCRIPT  🐲 ◄◄ <<=====   \033[1;37m"
msg -bar2
...
install_oficial() {
  ...
  wget -O /bin/resetsshdrop https://raw.githubusercontent.com/NearVPS/VPS-MX_Oficial/master/LINKS-LIBRERIAS/resetsshdrop &>/dev/null
  ...
  v1=$(curl -sSL "https://raw.githubusercontent.com/NearVPS/VPS-MX_Oficial/master/SCRIPT-v8.4g%20Oficial/Version")
  echo "$v1" >/etc/versin_script
  wget -O /etc/versin_script_new https://raw.githubusercontent.com/NearVPS/VPS-MX_Oficial/master/SCRIPT-v8.5x%20Mod/Version &>/dev/null
  ...
  echo 'wget -O /etc/versin_script_new https://raw.githubusercontent.com/NearVPS/VPS-MX_Oficial/master/SCRIPT-v8.4g%20Oficial/Version &>/dev/null' >>.bashrc
  echo 'echo "" ' >>.bashrc
...
install_mod() {
  ...
  rm -rf /usr/local/lib/systemubu1 &>/dev/null
  rm -rf /etc/versin_script &>/dev/null
  v1=$(curl -sSL "https://raw.githubusercontent.com/NearVPS/VPS-MX_Oficial/master/SCRIPT-v8.5x%20Mod/Version")
  echo "$v1" >/etc/versin_script
  wget -O /etc/versin_script_new https://raw.githubusercontent.com/NearVPS/VPS-MX_Oficial/master/SCRIPT-v8.5x%20Mod/Version &>/dev/null
  echo '#!/bin/sh -e' >/etc/rc.local
  sudo chmod +x /etc/rc.local
  ...
  echo 'echo -e "\t\033[91m   \ V / |  __/ ___) |_____| |  | |/  \  " ' >>.bashrc
  echo 'echo -e "\t\033[91m    \_/  |_|   |____/      |_|  |_/_/\_\ " ' >>.bashrc
  echo 'wget -O /etc/versin_script_new https://raw.githubusercontent.com/NearVPS/VPS-MX_Oficial/master/SCRIPT-v8.5x%20Mod/Version &>/dev/null' >>.bashrc
  echo 'echo "" ' >>.bashrc
  echo 'mess1="$(less /etc/VPS-MX/message.txt)" ' >>.bashrc
  echo 'echo "" ' >>.bashrc
  echo 'echo -e "\t\033[92mRESELLER : $mess1 "' >>.bashrc
